# credit to https://github.com/LeouYing/CRUX-BCI-Project-2023/blob/main/lsl/lsl.py for most of this code
...
while True:
    ...
    if len(data) > 500:
        ...
        # TODO: raise the signal for pausing the documentary here
        # pseudocode for it:
        # if xf <= baseline_threshold * 0.8:
            # pause = True
        # else:
            # pause = False
